...
<body>
    ...
    if (!isset($_COOKIE['words'])) {
        ...
        <?php
        setcookie("index_question", '', time() - 3600);
        setcookie("count_questions", '', time() - 3600);
        setcookie("words", '', time() - 3600);
        setcookie("answers", '', time() - 3600);
        setcookie("correct_answers", '', time() - 3600);
    }
